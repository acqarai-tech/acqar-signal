...
def get_seed_events() -> list:
    ...
    _ev("003", "RERA announces mandatory blockchain title deed registration effective Q3 2026",
        "Dubai's Real Estate Regulatory Agency (RERA) has issued a directive requiring all property transactions to be registered on Dubai's blockchain-backed title deed system from July 2026. This affects all off-plan and secondary market transactions.",
        "regulatory", 5, "DIFC", 25.2048, 55.2708, hours_ago=2.0, source="Gulf News"),
    ...
    _ev("034", "Dubai Internet City residences — tech workers drive premium rental demand",
        "Internet City adjacent towers (Tecom, IMPZ area) are seeing tech worker rental demand. Average rents for 2BR units now AED 120,000-140,000/year, up 12% from Q4 2026.",
        "rental_yield", 2, "Dubai Internet City", 25.0952, 55.1581, hours_ago=44.0, source="Property Finder"),
    ...
    _ev("040", "Rashidiya townhouses — heritage area properties appreciated 28% in 2026",
        "Rashidiya heritage townhouses have appreciated 28% in 2026 as buyers seek authentic Dubai architecture. Limited supply and preservation orders cap new development.",
        "price_signal", 2, "Rashidiya", 25.2302, 55.3600, hours_ago=56.0, source="The National"),
