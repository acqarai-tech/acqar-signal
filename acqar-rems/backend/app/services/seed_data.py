...
"""
Seed data disabled.
Returning empty list so no fake 2025 headlines pollute the live feed.
Real data comes from the pipeline fetchers on startup.
"""


def get_seed_events() -> list:
    """No seed data — live pipeline fetches real articles on startup."""
    return []
