...
// import { Routes, Route, Navigate, useLocation, useParams, useSearchParams } from 'react-router-dom'  // ← add useLocation
// import { useState, useEffect } from 'react'
// import { supabase } from './lib/supabase'
// import Dashboard from './pages/Dashboard'
// import { EventsProvider } from './context/EventsContext'
...
//     const nameFromUrl = searchParams.get('area')
//     const zoneFromUrl = searchParams.get('zone')

//     if (idFromUrl) {
//       fetch(
//         `${SUPA_URL}/rest/v1/area_intelligence?area_id=eq.${idFromUrl}&select=*&limit=1`,
//         { headers: { apikey: SUPA_KEY, Authorization: `Bearer ${SUPA_KEY}` } }
//       )
//         .then(r => r.json())
//         .then(data => {
...
//             setArea({
//               name: nameFromUrl,
//               zone: zoneFromUrl || 'Emerging',
//               area_id: Number(idFromUrl),
//               pricePerSqft: 1200,
//               score: 60,
//               yield: 6.5,
//             })
...
//       flexDirection: 'column', gap: 16, background: '#FAF8F5'
//     }}>
//       <div style={{ fontWeight: 900, fontSize: 17 }}>
//         <span style={{ color: '#C8732A' }}>ACQ</span>AR
//       </div>
//       <div style={{ width: 34, height: 34, borderRadius: '50%', border: '4px solid #E8E0D0', borderTopColor: '#C8732A', animation: 'spin 0.8s linear infinite' }} />
...
return (
    <EventsProvider>
      <AllAreaSpecialistPage area={area} onClose={() => window.history.back()} username={username} />
    </EventsProvider>
  )
}
function PageTracker() {
