...
//   useEffect(() => {
//     if (!area.dxbSlug) { setLoading(false); return }
//     setLoading(true)
//     fetch(`https://acqar-signal-production.up.railway.app/api/area/${area.dxbSlug}/full?persona=${persona}`)
//       .then(r => r.json())
//       .then(data => { setLiveData(data); setLoading(false) })
//       .catch(() => setLoading(false))
//   }, [area.dxbSlug, persona])

//   const live = liveData || {}
//   const psf = live.pricePerSqft || area.pricePerSqft
//   const score = live.score || area.score
//   const verdict = live.verdict || (score >= 75 ? 'BUY' : score >= 65 ? 'HOLD' : 'WATCH')

//   const d = buildAreaData({ ...area, pricePerSqft: psf, score: score })
...
//   if (loading) return (
//     <div style={{ height:'100%', display:'flex', alignItems:'center', justifyContent:'center', flexDirection:'column', gap:12, background:'#FAF8F5' }}>
//       <div style={{ fontSize:32 }}>📡</div>
//       <div style={{ fontSize:13, color:'#6E7A8A' }}>Loading live DLD data for {area.name}...</div>
//     </div>
//   )
...
//      {/* ── TICKER ── */}
// <TickerBar areaSlug={area.dxbSlug ? `jumeirah-village-circle` : 'area-59'} areaName={area.name} fallback={d} />
...
//           <div style={{ fontSize: 10, fontWeight: 800, textTransform: 'uppercase', letterSpacing: '.14em', color: C.orange, marginBottom: 6 }}>Area Specialist · AI Brief · Updated May 2026</div>
//           <div style={{ fontSize: 13.5, lineHeight: 1.75, color: C.text2 }}>
//             {live.aiBrief || `${area.name} delivers a gross rental yield of ${area.yield}% with an investment score of ${score}/100. Verdict: ${verdict}.`}
//           </div>
//           <div style={{ marginTop: 8, fontSize: 11, color: C.muted, display: 'flex', gap: 18, flexWrap: 'wrap' }}>
//             <span>🕐 Updated May 2026, 09:15 GST</span>
//             <span>📊 14 live data sources</span>
