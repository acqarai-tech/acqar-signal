...
// export default function FilterBar() {
//   const { filters, updateFilters, filteredEvents, events } = useEvents()
...
//       {/* Count */}
//       <div style={{ fontSize: '10px', color: '#B3B3B3', display: 'flex', justifyContent: 'space-between' }}>
//         <span>{filteredEvents.length} events shown</span>
//         <span style={{ color: '#555' }}>{events.length} total loaded</span>
//       </div>
//     </div>
//   )
// }
