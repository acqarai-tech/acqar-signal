                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      height: '100%',
                      borderRight: '1px solid var(--border-color)',
borderLeft: isFirstStock ? '1px solid var(--border-color)' : 'none',
                    }}
                  >
                    {/* Symbol/Name */}
                   <span style={{
  ...
  borderRadius: '2px',
        ...
        <div style={{
          ...
          width: '20px',
          height: '100%',
          background: 'linear-gradient(to right, var(--map-fade-color), transparent)',
          pointerEvents: 'none',
          zIndex: 1,
        }} />
        ...
        <div style={{
          ...
          width: '20px',
          height: '100%',
          background: 'linear-gradient(to left, var(--map-fade-color), transparent)',
          pointerEvents: 'none',
          zIndex: 1,
        }} />
      </div>
