  ...
  return (
    <div
      ...
      style={{
        position: "fixed",
        inset: 0,
        zIndex: 9999, // ✅ FIXED: was 999, now 9999 — shows above nav & ticker on mobile
        background: "rgba(0,0,0,0.75)",
        backdropFilter: "blur(6px)",
        WebkitBackdropFilter: "blur(6px)", // ✅ FIXED: added for iOS Safari
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        padding: "24px",
        touchAction: "manipulation", // ✅ FIXED: prevents scroll hijack on mobile
      }}
    >
      <div
        style={{
          ...
          position: "relative",
          boxShadow:
            "0 0 0 1px rgba(255,255,255,0.05), 0 40px 80px rgba(0,0,0,0.7)",
        }}
      >
        {/* Close button */}
        <button
          ...
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            touchAction: "manipulation", // ✅ FIXED
            WebkitTapHighlightColor: "transparent", // ✅ FIXED
          }}
        >
          ×
        </button>
        ...
        <div style={{ marginBottom: 28, textAlign: "center" }}>
          ...
          >
            <span style={{ color: "#B87333" }}>ACQ</span>
            <span style={{ color: "#F2F0EB" }}>AR</span>{" "}
            <span style={{ color: "#6B6560", fontWeight: 500, fontSize: 14 }}>
              Signal
            </span>
          </div>
          <p style={{ fontSize: 13, color: "#B8B3A8", margin: 0 }}>
        ...
        <form onSubmit={handleSignIn}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              onFocus={(e) =>
                (e.target.style.borderColor = "rgba(184,115,51,0.6)")
              }
              onBlur={(e) =>
          ...
          <button
            ...
            style={{
              width: "100%",
              background: loading ? "#8C5A25" : "#B87333",
              border: "none",
              borderRadius: "8px",
              padding: "13px",
              fontSize: 15,
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ color: "#B87333", touchAction: "manipulation" }} // ✅ FIXED
          >
            ACQAR
          </a>{" "}
          to request an account.
