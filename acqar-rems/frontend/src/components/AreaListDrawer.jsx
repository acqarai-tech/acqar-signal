...
export const DUBAI_AREAS_LIST = [
  // PRIME
  { name: 'Downtown Dubai', zone: 'Prime', dxbSlug: 'burj-khalifa', lat: 25.1972, lng: 55.2744, pricePerSqft: 4200, yield: 5.2, score: 84 },
  { name: 'Palm Jumeirah', zone: 'Prime', dxbSlug: 'palm-jumeirah', lat: 25.1124, lng: 55.1390, pricePerSqft: 4000, yield: 4.2, score: 81 },
  { name: 'DIFC', zone: 'Prime', dxbSlug: 'difc', lat: 25.2048, lng: 55.2708, pricePerSqft: 3200, yield: 5.7, score: 82 },
  { name: 'Jumeirah Bay Island', zone: 'Prime', dxbSlug: 'jumeirah-bay-island', lat: 25.2000, lng: 55.2600, pricePerSqft: 5200, yield: 3.5, score: 77 },
  { name: 'Emirates Hills', zone: 'Prime', dxbSlug: 'emirates-hills', lat: 25.0654, lng: 55.1619, pricePerSqft: 4500, yield: 3.2, score: 75 },
  { name: 'Burj Khalifa District', zone: 'Prime', dxbSlug: 'burj-khalifa', lat: 25.1940, lng: 55.2730, pricePerSqft: 4100, yield: 5.0, score: 81 },
  { name: 'Dubai Mall Surrounds', zone: 'Prime', dxbSlug: 'burj-khalifa', lat: 25.1975, lng: 55.2796, pricePerSqft: 3900, yield: 5.3, score: 79 },
  { name: 'Jumeirah', zone: 'Prime', dxbSlug: 'jumeirah-1', lat: 25.2048, lng: 55.2419, pricePerSqft: 2800, yield: 5.0, score: 73 },
  { name: 'La Mer', zone: 'Prime', dxbSlug: 'la-mer', lat: 25.2250, lng: 55.2580, pricePerSqft: 3100, yield: 4.8, score: 74 },
  { name: 'Bluewaters Island', zone: 'Prime', dxbSlug: 'bluewaters-island', lat: 25.0803, lng: 55.1200, pricePerSqft: 3400, yield: 4.6, score: 72 },
  { name: 'Jumeirah 1', zone: 'Prime', dxbSlug: 'jumeirah-1', lat: 25.2100, lng: 55.2500, pricePerSqft: 2700, yield: 5.0, score: 73 },
  { name: 'Jumeirah 2', zone: 'Prime', dxbSlug: 'jumeirah-2', lat: 25.1900, lng: 55.2400, pricePerSqft: 2600, yield: 5.1, score: 72 },
  { name: 'Jumeirah 3', zone: 'Prime', dxbSlug: 'jumeirah-3', lat: 25.1750, lng: 55.2300, pricePerSqft: 2500, yield: 5.3, score: 71 },
  { name: 'City Walk', zone: 'Prime', dxbSlug: 'city-walk', lat: 25.1980, lng: 55.2420, pricePerSqft: 2900, yield: 5.1, score: 74 },
  { name: 'DIFC Living', zone: 'Prime', dxbSlug: 'difc', lat: 25.2100, lng: 55.2750, pricePerSqft: 3300, yield: 5.4, score: 79 },
  { name: 'One Za abeel', zone: 'Prime', dxbSlug: 'za-abeel', lat: 25.2200, lng: 55.2900, pricePerSqft: 3700, yield: 4.8, score: 78 },
  { name: 'Burj Binghatti', zone: 'Prime', dxbSlug: 'business-bay', lat: 25.1850, lng: 55.2620, pricePerSqft: 3500, yield: 4.9, score: 77 },
  { name: 'Six Senses Residences', zone: 'Prime', dxbSlug: 'palm-jumeirah', lat: 25.1130, lng: 55.1400, pricePerSqft: 5000, yield: 3.2, score: 73 },
  { name: 'Atlantis The Royal Residences', zone: 'Prime', dxbSlug: 'palm-jumeirah', lat: 25.1160, lng: 55.1160, pricePerSqft: 5800, yield: 3.0, score: 71 },
  { name: 'Ellington Beach House', zone: 'Prime', dxbSlug: 'palm-jumeirah', lat: 25.1100, lng: 55.1380, pricePerSqft: 3200, yield: 4.6, score: 75 },
  { name: 'Palma Residences', zone: 'Prime', dxbSlug: 'palm-jumeirah', lat: 25.1100, lng: 55.1380, pricePerSqft: 3600, yield: 4.0, score: 75 },
  { name: 'Bluewaters Residences', zone: 'Prime', dxbSlug: 'bluewaters-island', lat: 25.0800, lng: 55.1180, pricePerSqft: 3200, yield: 4.5, score: 73 },
  { name: 'The World Islands', zone: 'Prime', dxbSlug: 'the-world-islands', lat: 25.2100, lng: 55.1500, pricePerSqft: 2900, yield: 4.3, score: 70 },
  { name: 'Boxpark Jumeirah', zone: 'Prime', dxbSlug: 'jumeirah-1', lat: 25.1900, lng: 55.2350, pricePerSqft: 2600, yield: 5.4, score: 72 },

  // MARINA
  { name: 'Dubai Marina', zone: 'Marina', dxbSlug: 'marsa-dubai', lat: 25.0761, lng: 55.1403, pricePerSqft: 2300, yield: 5.6, score: 78 },
  { name: 'JBR', zone: 'Marina', dxbSlug: 'jumeirah-beach-residence', lat: 25.0785, lng: 55.1333, pricePerSqft: 2400, yield: 5.8, score: 76 },
  { name: 'Marina Gate', zone: 'Marina', dxbSlug: 'marsa-dubai', lat: 25.0740, lng: 55.1390, pricePerSqft: 2350, yield: 5.9, score: 75 },
  { name: 'Marina Promenade', zone: 'Marina', dxbSlug: 'marsa-dubai', lat: 25.0775, lng: 55.1420, pricePerSqft: 2200, yield: 6.0, score: 74 },
  { name: 'Dubai Harbour', zone: 'Marina', dxbSlug: 'dubai-harbour', lat: 25.0720, lng: 55.1270, pricePerSqft: 2600, yield: 5.5, score: 75 },

  // BUSINESS
  { name: 'Business Bay', zone: 'Business', dxbSlug: 'business-bay', lat: 25.1865, lng: 55.2644, pricePerSqft: 2901, yield: 5.7, score: 78 },
  { name: 'Dubai Internet City', zone: 'Business', dxbSlug: 'dubai-internet-city', lat: 25.0952, lng: 55.1581, pricePerSqft: 1800, yield: 7.0, score: 71 },
  { name: 'Dubai Media City', zone: 'Business', dxbSlug: 'dubai-media-city', lat: 25.1001, lng: 55.1568, pricePerSqft: 1850, yield: 6.8, score: 70 },
  { name: 'Tecom', zone: 'Business', dxbSlug: 'tecom', lat: 25.1001, lng: 55.1568, pricePerSqft: 1700, yield: 7.2, score: 69 },
  { name: 'One Central', zone: 'Business', dxbSlug: 'trade-centre', lat: 25.2250, lng: 55.2830, pricePerSqft: 2000, yield: 6.5, score: 71 },
  { name: 'Dubai Investment Park', zone: 'Business', dxbSlug: 'dubai-investment-park-1', lat: 25.0200, lng: 55.1600, pricePerSqft: 773, yield: 9.9, score: 61 },
  { name: 'Dubai Science Park', zone: 'Business', dxbSlug: 'barsha-heights', lat: 25.0950, lng: 55.2180, pricePerSqft: 1350, yield: 7.2, score: 64 },
  { name: 'Ras Al Khor Industrial', zone: 'Business', dxbSlug: 'ras-al-khor', lat: 25.1850, lng: 55.3600, pricePerSqft: 900, yield: 9.5, score: 56 },
  { name: 'Al Quoz Industrial', zone: 'Business', dxbSlug: 'al-quoz', lat: 25.1400, lng: 55.2400, pricePerSqft: 950, yield: 8.8, score: 56 },

  // MID-MARKET
  { name: 'JVC', zone: 'Mid-Market', dxbSlug: 'jumeirah-village-circle', lat: 25.0586, lng: 55.2069, pricePerSqft: 1473, yield: 6.7, score: 69 },
  { name: 'JVT', zone: 'Mid-Market', dxbSlug: 'jumeirah-village-triangle', lat: 25.0550, lng: 55.1950, pricePerSqft: 1350, yield: 7.0, score: 66 },
  { name: 'Arjan', zone: 'Mid-Market', dxbSlug: 'arjan', lat: 25.0620, lng: 55.2150, pricePerSqft: 1355, yield: 8.2, score: 65 },
  { name: 'Dubai Production City', zone: 'Mid-Market', dxbSlug: 'production-city', lat: 25.0400, lng: 55.2080, pricePerSqft: 1150, yield: 8.5, score: 63 },
  { name: 'Dubai Studio City', zone: 'Mid-Market', dxbSlug: 'studio-city', lat: 25.0400, lng: 55.1900, pricePerSqft: 1100, yield: 8.8, score: 62 },
  { name: 'Sports City', zone: 'Mid-Market', dxbSlug: 'dubai-sports-city', lat: 25.0450, lng: 55.2250, pricePerSqft: 1180, yield: 8.5, score: 64 },
  { name: 'Motor City', zone: 'Mid-Market', dxbSlug: 'motor-city', lat: 25.0460, lng: 55.2380, pricePerSqft: 1200, yield: 8.3, score: 64 },
  { name: 'Town Square', zone: 'Mid-Market', dxbSlug: 'town-square', lat: 24.9935, lng: 55.1958, pricePerSqft: 1050, yield: 7.7, score: 61 },
  { name: 'Remraam', zone: 'Mid-Market', dxbSlug: 'remraam', lat: 25.0250, lng: 55.1700, pricePerSqft: 980, yield: 8.8, score: 60 },
  { name: 'Living Legends', zone: 'Mid-Market', dxbSlug: 'living-legends', lat: 25.0550, lng: 55.3200, pricePerSqft: 1020, yield: 8.8, score: 60 },
  { name: 'Discovery Gardens', zone: 'Mid-Market', dxbSlug: 'discovery-gardens', lat: 25.0400, lng: 55.1350, pricePerSqft: 950, yield: 9.5, score: 58 },
  { name: 'International City', zone: 'Mid-Market', dxbSlug: 'international-city', lat: 25.1638, lng: 55.4172, pricePerSqft: 750, yield: 10.0, score: 56 },
  { name: 'Silicon Oasis', zone: 'Mid-Market', dxbSlug: 'silicon-oasis', lat: 25.1186, lng: 55.3838, pricePerSqft: 1501, yield: 8.5, score: 62 },
  { name: 'Academic City', zone: 'Mid-Market', dxbSlug: 'academic-city', lat: 25.1130, lng: 55.4250, pricePerSqft: 980, yield: 9.0, score: 58 },
  { name: 'Majan', zone: 'Mid-Market', dxbSlug: 'majan', lat: 25.0950, lng: 55.3800, pricePerSqft: 1050, yield: 8.5, score: 59 },
  { name: 'Dubailand', zone: 'Mid-Market', dxbSlug: 'dubailand', lat: 25.0600, lng: 55.3500, pricePerSqft: 1100, yield: 8.2, score: 62 },
  { name: 'Liwan', zone: 'Mid-Market', dxbSlug: 'liwan', lat: 25.0750, lng: 55.3900, pricePerSqft: 980, yield: 8.8, score: 59 },
  { name: 'Wadi Al Safa', zone: 'Mid-Market', dxbSlug: 'wadi-al-safa-5', lat: 25.0700, lng: 55.3700, pricePerSqft: 1020, yield: 8.6, score: 60 },
  { name: 'Al Furjan', zone: 'Mid-Market', dxbSlug: 'al-furjan', lat: 25.0150, lng: 55.1290, pricePerSqft: 1200, yield: 7.7, score: 63 },
  { name: 'Jumeirah Village Triangle', zone: 'Mid-Market', dxbSlug: 'jumeirah-village-triangle', lat: 25.0450, lng: 55.1600, pricePerSqft: 1280, yield: 7.5, score: 64 },
  { name: 'Al Khail Heights', zone: 'Mid-Market', dxbSlug: 'al-khail-heights', lat: 25.1180, lng: 55.3180, pricePerSqft: 1150, yield: 7.8, score: 63 },
  { name: 'Seasons Community', zone: 'Mid-Market', dxbSlug: 'seasons-community', lat: 25.2200, lng: 55.3800, pricePerSqft: 920, yield: 9.2, score: 58 },
  { name: 'Warsan', zone: 'Mid-Market', dxbSlug: 'al-warsan-1', lat: 25.1750, lng: 55.3950, pricePerSqft: 880, yield: 9.5, score: 57 },
  { name: 'Mirdif Hills', zone: 'Mid-Market', dxbSlug: 'mirdif', lat: 25.2200, lng: 55.4100, pricePerSqft: 1150, yield: 7.5, score: 62 },
  { name: 'Al Furjan Pavilion', zone: 'Mid-Market', dxbSlug: 'al-furjan', lat: 25.0120, lng: 55.1250, pricePerSqft: 1100, yield: 8.0, score: 62 },
  { name: 'Falcon City', zone: 'Mid-Market', dxbSlug: 'wadi-al-safa-5', lat: 25.0900, lng: 55.3700, pricePerSqft: 1020, yield: 8.5, score: 61 },
  { name: 'Nshama Town Square', zone: 'Mid-Market', dxbSlug: 'town-square', lat: 24.9920, lng: 55.1980, pricePerSqft: 1080, yield: 9.0, score: 61 },
  { name: 'Binghatti Avenue', zone: 'Mid-Market', dxbSlug: 'jumeirah-village-circle', lat: 25.0580, lng: 55.2080, pricePerSqft: 1200, yield: 8.0, score: 63 },
  { name: 'Pantheon Elysee', zone: 'Mid-Market', dxbSlug: 'jumeirah-village-circle', lat: 25.0560, lng: 55.2060, pricePerSqft: 1220, yield: 7.9, score: 63 },
  { name: 'Mag 5 Boulevard', zone: 'Mid-Market', dxbSlug: 'dubai-south', lat: 25.0350, lng: 55.1900, pricePerSqft: 1050, yield: 8.6, score: 60 },

  // VILLAS
  { name: 'Dubai Hills Estate', zone: 'Villas', dxbSlug: 'dubai-hills-estate', lat: 25.1017, lng: 55.2314, pricePerSqft: 2100, yield: 5.7, score: 76 },
  { name: 'Arabian Ranches', zone: 'Villas', dxbSlug: 'arabian-ranches', lat: 25.0639, lng: 55.2690, pricePerSqft: 1900, yield: 5.2, score: 73 },
  { name: 'Arabian Ranches 2', zone: 'Villas', dxbSlug: 'arabian-ranches-2', lat: 25.0550, lng: 55.2750, pricePerSqft: 1850, yield: 5.3, score: 72 },
  { name: 'Arabian Ranches 3', zone: 'Villas', dxbSlug: 'arabian-ranches-3', lat: 25.0450, lng: 55.2900, pricePerSqft: 1650, yield: 5.6, score: 70 },
  { name: 'Damac Hills', zone: 'Villas', dxbSlug: 'damac-hills', lat: 25.0400, lng: 55.2500, pricePerSqft: 1420, yield: 7.6, score: 68 },
  { name: 'Damac Hills 2', zone: 'Villas', dxbSlug: 'damac-hills-2', lat: 24.9700, lng: 55.3100, pricePerSqft: 1075, yield: 6.2, score: 63 },
  { name: 'Mudon', zone: 'Villas', dxbSlug: 'mudon', lat: 25.0200, lng: 55.2600, pricePerSqft: 1350, yield: 6.2, score: 66 },
  { name: 'The Springs', zone: 'Villas', dxbSlug: 'the-springs', lat: 25.0603, lng: 55.1619, pricePerSqft: 1550, yield: 5.8, score: 68 },
  { name: 'The Meadows', zone: 'Villas', dxbSlug: 'the-meadows', lat: 25.0650, lng: 55.1550, pricePerSqft: 1700, yield: 5.5, score: 69 },
  { name: 'The Lakes', zone: 'Villas', dxbSlug: 'the-lakes', lat: 25.0580, lng: 55.1500, pricePerSqft: 1750, yield: 5.4, score: 69 },
  { name: 'The Greens', zone: 'Villas', dxbSlug: 'the-greens', lat: 25.0700, lng: 55.1480, pricePerSqft: 1620, yield: 5.9, score: 68 },
  { name: 'The Views', zone: 'Villas', dxbSlug: 'the-views', lat: 25.0680, lng: 55.1460, pricePerSqft: 1650, yield: 5.7, score: 68 },
  { name: 'Jumeirah Park', zone: 'Villas', dxbSlug: 'jumeirah-park', lat: 25.0480, lng: 55.1550, pricePerSqft: 1720, yield: 5.2, score: 68 },
  { name: 'Jumeirah Islands', zone: 'Villas', dxbSlug: 'jumeirah-islands', lat: 25.0500, lng: 55.1400, pricePerSqft: 1900, yield: 5.0, score: 69 },
  { name: 'Jumeirah Golf Estates', zone: 'Villas', dxbSlug: 'jumeirah-golf-estates', lat: 25.0250, lng: 55.1650, pricePerSqft: 1800, yield: 4.8, score: 68 },
  { name: 'Victory Heights', zone: 'Villas', dxbSlug: 'victory-heights', lat: 25.0300, lng: 55.2200, pricePerSqft: 1380, yield: 6.0, score: 64 },
  { name: 'Tiger Woods Dubai', zone: 'Villas', dxbSlug: 'jumeirah-golf-estates', lat: 25.0280, lng: 55.1620, pricePerSqft: 1850, yield: 5.0, score: 67 },
  { name: 'Polo Homes', zone: 'Villas', dxbSlug: 'arabian-ranches', lat: 25.0850, lng: 55.2850, pricePerSqft: 1400, yield: 5.8, score: 64 },
  { name: 'The Sustainable City', zone: 'Villas', dxbSlug: 'sustainable-city', lat: 24.9890, lng: 55.2090, pricePerSqft: 1600, yield: 6.0, score: 67 },
  { name: 'Akoya Oxygen', zone: 'Villas', dxbSlug: 'damac-hills-2', lat: 24.9700, lng: 55.2550, pricePerSqft: 1050, yield: 7.5, score: 62 },
  { name: 'Villanova', zone: 'Villas', dxbSlug: 'villanova', lat: 25.0550, lng: 55.3400, pricePerSqft: 1250, yield: 6.8, score: 64 },
  { name: 'Serena', zone: 'Villas', dxbSlug: 'serena', lat: 25.0500, lng: 55.3350, pricePerSqft: 1280, yield: 5.4, score: 63 },
  { name: 'Reem Townhouses', zone: 'Villas', dxbSlug: 'arabian-ranches', lat: 25.0680, lng: 55.2800, pricePerSqft: 1350, yield: 6.5, score: 64 },
  { name: 'Nakheel Communities', zone: 'Villas', dxbSlug: 'jumeirah-park', lat: 25.0600, lng: 55.1700, pricePerSqft: 1650, yield: 5.6, score: 67 },

  // OLD DUBAI
  { name: 'Deira', zone: 'Old Dubai', dxbSlug: 'deira', lat: 25.2697, lng: 55.3094, pricePerSqft: 1100, yield: 7.5, score: 59 },
  { name: 'Bur Dubai', zone: 'Old Dubai', dxbSlug: 'bur-dubai', lat: 25.2532, lng: 55.2868, pricePerSqft: 1050, yield: 7.8, score: 58 },
  { name: 'Karama', zone: 'Old Dubai', dxbSlug: 'al-karama', lat: 25.2532, lng: 55.2868, pricePerSqft: 980, yield: 8.2, score: 57 },
  { name: 'Oud Metha', zone: 'Old Dubai', dxbSlug: 'oud-metha', lat: 25.2300, lng: 55.3100, pricePerSqft: 1080, yield: 7.7, score: 59 },
  { name: 'Al Mankhool', zone: 'Old Dubai', dxbSlug: 'al-mankhool', lat: 25.2400, lng: 55.2800, pricePerSqft: 1020, yield: 8.0, score: 57 },
  { name: 'Al Baraha', zone: 'Old Dubai', dxbSlug: 'al-baraha', lat: 25.2700, lng: 55.3200, pricePerSqft: 950, yield: 8.5, score: 55 },
  { name: 'Garhoud', zone: 'Old Dubai', dxbSlug: 'garhoud', lat: 25.2450, lng: 55.3450, pricePerSqft: 1100, yield: 7.6, score: 59 },
  { name: 'Muhaisnah', zone: 'Old Dubai', dxbSlug: 'muhaisnah-1', lat: 25.2500, lng: 55.3400, pricePerSqft: 980, yield: 8.3, score: 56 },
  { name: 'Rashidiya', zone: 'Old Dubai', dxbSlug: 'al-rashidiya', lat: 25.2302, lng: 55.3600, pricePerSqft: 1020, yield: 8.1, score: 57 },
  { name: 'Mirdif', zone: 'Old Dubai', dxbSlug: 'mirdif', lat: 25.2149, lng: 55.4150, pricePerSqft: 1150, yield: 7.5, score: 60 },
  { name: 'Hor Al Anz', zone: 'Old Dubai', dxbSlug: 'hor-al-anz', lat: 25.2780, lng: 55.3350, pricePerSqft: 920, yield: 8.7, score: 55 },
  { name: 'Qusais', zone: 'Old Dubai', dxbSlug: 'al-qusais-1', lat: 25.2600, lng: 55.3750, pricePerSqft: 850, yield: 9.3, score: 54 },
  { name: 'Nadd Al Hamar', zone: 'Old Dubai', dxbSlug: 'nadd-al-hamar', lat: 25.2100, lng: 55.3600, pricePerSqft: 900, yield: 9.0, score: 56 },
  { name: 'Nad Al Sheba', zone: 'Old Dubai', dxbSlug: 'nad-al-sheba-1', lat: 25.1600, lng: 55.3200, pricePerSqft: 1200, yield: 7.5, score: 61 },
  { name: 'Al Twar', zone: 'Old Dubai', dxbSlug: 'al-twar-1', lat: 25.2600, lng: 55.3500, pricePerSqft: 900, yield: 8.9, score: 55 },
  { name: 'Al Mizhar', zone: 'Old Dubai', dxbSlug: 'al-mizhar-1', lat: 25.2350, lng: 55.4000, pricePerSqft: 950, yield: 8.5, score: 56 },
  { name: 'Muhaisanah', zone: 'Old Dubai', dxbSlug: 'muhaisnah-1', lat: 25.2500, lng: 55.3550, pricePerSqft: 880, yield: 9.1, score: 54 },
  { name: 'Al Nahda', zone: 'Old Dubai', dxbSlug: 'al-nahda-1', lat: 25.2650, lng: 55.3450, pricePerSqft: 980, yield: 8.6, score: 57 },
  { name: 'Al Qusais', zone: 'Old Dubai', dxbSlug: 'al-qusais-1', lat: 25.2580, lng: 55.3780, pricePerSqft: 860, yield: 9.4, score: 54 },
  { name: 'Al Hudaiba', zone: 'Old Dubai', dxbSlug: 'al-hudaiba', lat: 25.2400, lng: 55.2700, pricePerSqft: 1120, yield: 7.8, score: 58 },
  { name: 'Satwa', zone: 'Old Dubai', dxbSlug: 'al-satwa', lat: 25.2300, lng: 55.2600, pricePerSqft: 1200, yield: 7.5, score: 60 },
  { name: 'Al Mina', zone: 'Old Dubai', dxbSlug: 'al-mina', lat: 25.2300, lng: 55.2800, pricePerSqft: 1080, yield: 8.0, score: 57 },
  { name: 'Muhaisna', zone: 'Old Dubai', dxbSlug: 'muhaisnah-1', lat: 25.2480, lng: 55.3380, pricePerSqft: 900, yield: 9.2, score: 54 },

  // CREEK
  { name: 'Dubai Creek Harbour', zone: 'Creek', dxbSlug: 'dubai-creek-harbour', lat: 25.2000, lng: 55.3200, pricePerSqft: 2200, yield: 6.2, score: 76 },
  { name: 'Meydan', zone: 'Creek', dxbSlug: 'meydan', lat: 25.1718, lng: 55.3092, pricePerSqft: 1900, yield: 6.2, score: 73 },
  { name: 'MBR City', zone: 'Creek', dxbSlug: 'mohammed-bin-rashid-city', lat: 25.1900, lng: 55.3100, pricePerSqft: 2050, yield: 5.8, score: 74 },
  { name: 'Ras Al Khor', zone: 'Creek', dxbSlug: 'ras-al-khor', lat: 25.1800, lng: 55.3500, pricePerSqft: 1350, yield: 7.0, score: 65 },
  { name: 'Sobha Hartland', zone: 'Creek', dxbSlug: 'sobha-hartland', lat: 25.1950, lng: 55.3050, pricePerSqft: 2100, yield: 5.9, score: 73 },
  { name: 'Al Jaddaf', zone: 'Creek', dxbSlug: 'al-jaddaf', lat: 25.2130, lng: 55.3280, pricePerSqft: 1600, yield: 6.5, score: 68 },
  { name: 'Culture Village', zone: 'Creek', dxbSlug: 'al-jaddaf', lat: 25.2200, lng: 55.3350, pricePerSqft: 1550, yield: 6.7, score: 67 },
  { name: 'Azizi Riviera', zone: 'Creek', dxbSlug: 'meydan', lat: 25.1800, lng: 55.3050, pricePerSqft: 1600, yield: 6.8, score: 67 },
  { name: 'Hartland Forest', zone: 'Creek', dxbSlug: 'sobha-hartland', lat: 25.1980, lng: 55.3000, pricePerSqft: 2000, yield: 6.0, score: 70 },

  // SOUTH
  { name: 'Dubai South', zone: 'South', dxbSlug: 'dubai-south', lat: 24.8974, lng: 55.1650, pricePerSqft: 1139, yield: 7.8, score: 67 },
  { name: 'Expo City', zone: 'South', dxbSlug: 'dubai-south', lat: 24.9674, lng: 55.1570, pricePerSqft: 1350, yield: 7.5, score: 68 },
  { name: 'Dubai World Central', zone: 'South', dxbSlug: 'dubai-south', lat: 24.8974, lng: 55.1650, pricePerSqft: 1100, yield: 8.0, score: 65 },
  { name: 'Emaar South', zone: 'South', dxbSlug: 'emaar-south', lat: 24.9450, lng: 55.1780, pricePerSqft: 1280, yield: 7.8, score: 66 },
  { name: 'Jebel Ali', zone: 'South', dxbSlug: 'jabal-ali-first', lat: 25.0069, lng: 55.0556, pricePerSqft: 1100, yield: 8.2, score: 62 },
  { name: 'Jebel Ali Village', zone: 'South', dxbSlug: 'jabal-ali-first', lat: 25.0200, lng: 55.0800, pricePerSqft: 1150, yield: 8.0, score: 63 },

  // MID-CENTRAL
  { name: 'Al Barsha', zone: 'Mid-Central', dxbSlug: 'al-barsha-1', lat: 25.1122, lng: 55.2011, pricePerSqft: 1350, yield: 7.2, score: 65 },
  { name: 'Al Barsha South', zone: 'Mid-Central', dxbSlug: 'al-barsha-south-1', lat: 25.0900, lng: 55.2100, pricePerSqft: 1250, yield: 7.5, score: 63 },
  { name: 'Umm Suqeim', zone: 'Mid-Central', dxbSlug: 'um-suqaim-third', lat: 25.1300, lng: 55.1900, pricePerSqft: 2000, yield: 5.6, score: 71 },
  { name: 'Umm Al Sheif', zone: 'Mid-Central', dxbSlug: 'um-suqaim-third', lat: 25.1350, lng: 55.2000, pricePerSqft: 1800, yield: 5.8, score: 69 },
  { name: 'Al Quoz', zone: 'Mid-Central', dxbSlug: 'al-quoz', lat: 25.1503, lng: 55.2341, pricePerSqft: 1150, yield: 8.2, score: 60 },
  { name: 'Al Safa', zone: 'Mid-Central', dxbSlug: 'al-safa', lat: 25.1700, lng: 55.2100, pricePerSqft: 2200, yield: 5.3, score: 72 },
  { name: 'Al Wasl', zone: 'Mid-Central', dxbSlug: 'al-wasl', lat: 25.1900, lng: 55.2350, pricePerSqft: 2350, yield: 5.1, score: 73 },
  { name: 'Al Manara', zone: 'Mid-Central', dxbSlug: 'al-manara', lat: 25.1600, lng: 55.2080, pricePerSqft: 2100, yield: 5.4, score: 71 },
  { name: 'Al Sufouh', zone: 'Mid-Central', dxbSlug: 'al-safouh-first', lat: 25.0950, lng: 55.1700, pricePerSqft: 1900, yield: 8.7, score: 70 },
  { name: 'Rosa Al Safa', zone: 'Mid-Central', dxbSlug: 'al-safa', lat: 25.1650, lng: 55.2150, pricePerSqft: 2050, yield: 5.4, score: 70 },

  // EMERGING
  { name: 'Dubai Hills Park', zone: 'Emerging', dxbSlug: 'dubai-hills-estate', lat: 25.0980, lng: 55.2350, pricePerSqft: 2200, yield: 5.5, score: 74 },
  { name: 'Tilal Al Ghaf', zone: 'Emerging', dxbSlug: 'al-yelayiss-1', lat: 25.0480, lng: 55.2600, pricePerSqft: 1700, yield: 5.8, score: 69 },
  { name: 'Emaar Beachfront', zone: 'Emerging', dxbSlug: 'emaar-beachfront', lat: 25.0750, lng: 55.1350, pricePerSqft: 2800, yield: 5.3, score: 75 },
  { name: 'Siniya Island', zone: 'Emerging', dxbSlug: 'siniya-island', lat: 25.5000, lng: 55.5800, pricePerSqft: 1800, yield: 5.8, score: 66 },
  { name: 'Palm Jebel Ali', zone: 'Emerging', dxbSlug: 'palm-jabal-ali', lat: 24.9900, lng: 55.0200, pricePerSqft: 2500, yield: 5.0, score: 70 },
  { name: 'Creek Views', zone: 'Emerging', dxbSlug: 'dubai-creek-harbour', lat: 25.2100, lng: 55.3300, pricePerSqft: 1750, yield: 6.2, score: 68 },
  { name: 'The Valley', zone: 'Emerging', dxbSlug: 'the-valley', lat: 24.9630, lng: 55.5120, pricePerSqft: 1150, yield: 7.5, score: 63 },
  { name: 'Dubai Islands', zone: 'Emerging', dxbSlug: 'palm-deira', lat: 25.3600, lng: 55.3500, pricePerSqft: 2200, yield: 5.7, score: 72 },

  // WATERFRONT
  { name: 'Port de La Mer', zone: 'Waterfront', dxbSlug: 'port-de-la-mer', lat: 25.2350, lng: 55.2700, pricePerSqft: 2900, yield: 4.9, score: 74 },
  { name: 'Marasi Marina', zone: 'Waterfront', dxbSlug: 'business-bay', lat: 25.1860, lng: 55.2680, pricePerSqft: 2500, yield: 5.4, score: 73 },
  { name: 'Dubai Water Canal', zone: 'Waterfront', dxbSlug: 'business-bay', lat: 25.1900, lng: 55.2600, pricePerSqft: 2400, yield: 5.6, score: 72 },
  { name: 'Deira Waterfront', zone: 'Waterfront', dxbSlug: 'deira', lat: 25.2750, lng: 55.3000, pricePerSqft: 1500, yield: 6.8, score: 64 },
  { name: 'Al Seef', zone: 'Waterfront', dxbSlug: 'al-seef', lat: 25.2400, lng: 55.3150, pricePerSqft: 1850, yield: 6.3, score: 68 },
  { name: 'Sobha SeaHaven', zone: 'Waterfront', dxbSlug: 'marsa-dubai', lat: 25.0780, lng: 55.1340, pricePerSqft: 2600, yield: 5.2, score: 73 },
  { name: 'Address Beach Resort', zone: 'Waterfront', dxbSlug: 'jumeirah-beach-residence', lat: 25.0760, lng: 55.1330, pricePerSqft: 3000, yield: 4.7, score: 72 },
  { name: 'Canal Front Residences', zone: 'Waterfront', dxbSlug: 'business-bay', lat: 25.1880, lng: 55.2580, pricePerSqft: 2500, yield: 5.6, score: 73 },
]
