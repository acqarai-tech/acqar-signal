...
//     const cutoff = Date.now() - filters.hours * 60 * 60 * 1000
//     result = result.filter(e => {
//       // Use created_at_ts (unix seconds) if available, else parse created_at string
...
//       confidence: 0.92,
//       source: 'Gulf News',
//       created_at: new Date(mins(20)).toISOString(),
//       created_at_ts: (now - 20 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     {
//       id: 'demo2',
...
//       created_at_ts: (now - 45 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     // within 1D (but not 1H)
//     {
...
//       confidence: 0.95,
//       source: 'The National',
//       created_at: new Date(mins(180)).toISOString(),
//       created_at_ts: (now - 180 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     {
//       id: 'demo4',
//       title: 'Business Bay Records 847 Transactions in March 2026',
//       summary: 'Business Bay continues to be Dubai top performing district with AED 1.2B total transaction value this month.',
//       category: 'transaction',
//       severity: 3,
...
//       confidence: 0.85,
//       source: 'Zawya',
//       created_at: new Date(mins(600)).toISOString(),
//       created_at_ts: (now - 600 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     // within 1W (but not 1D)
//     {
...
//       summary: 'Construction contracts worth AED 3.8B awarded for road and utility infrastructure on Palm Jebel Ali expansion.',
...
//       confidence: 0.91,
//       source: 'Gulf News',
//       created_at: new Date(mins(60 * 48)).toISOString(),
//       created_at_ts: (now - 60 * 48 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     {
//       id: 'demo6',
//       title: 'Dubai Marina Average Rental Yield Hits 7.2%',
//       summary: 'Marina district outperforms all other areas with highest rental yield in Q1 2026, attracting yield-focused investors.',
//       category: 'investment',
//       severity: 2,
...
//       confidence: 0.79,
//       source: 'GDELT',
//       created_at: new Date(mins(60 * 72)).toISOString(),
//       created_at_ts: (now - 60 * 72 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     // within 1M (but not 1W)
//     {
//       id: 'demo7',
//       title: 'Dubai Land Department Launches Smart Rental Index',
//       summary: 'New digital platform allows landlords and tenants to access real-time rental valuations across all districts.',
//       category: 'regulatory',
//       severity: 3,
//       lat: 25.2048, lng: 55.2708,
//       location_name: 'Dubai',
...
//       confidence: 0.87,
//       source: 'DLD',
//       created_at: new Date(mins(60 * 24 * 12)).toISOString(),
//       created_at_ts: (now - 60 * 24 * 12 * 60 * 1000) / 1000,
//       is_active: true
//     },
//     {
//       id: 'demo8',
//       title: 'JVC Emerges as Most Affordable Investment District',
//       summary: 'Jumeirah Village Circle records highest transaction volume among sub-AED 1M properties in Q1 2026.',
//       category: 'investment',
//       severity: 2,
//       lat: 25.0580, lng: 55.2100,
//       location_name: 'JVC',
//       signal_count: 22,
//       confidence: 0.81,
//       source: 'Property Monitor',
//       created_at: new Date(mins(60 * 24 * 20)).toISOString(),
//       created_at_ts: (now - 60 * 24 * 20 * 60 * 1000) / 1000,
//       is_active: true
//     },
//   ]
// }
...
export function EventsProvider({ children }) {
  ...
  const fetchEvents = useCallback(async () => {
    try {
      setIsLoading(true)
      const params = new URLSearchParams({
  hours: 720,  // Always fetch full 30 days from backend
  severity_min: '1',  // Always fetch all severities
  severity_max: '5',
  limit: '200'
})
      if (filters.categories.length === 1) params.append('category', filters.categories[0])
