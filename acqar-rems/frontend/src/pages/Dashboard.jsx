...
{/* Areas List Drawer */}
          ...
          <div style={{
            ...
            <button
              onClick={() => { setSelectedEvent(null); setMobileDrawer('feed'); trackEvent('feed_opened', { page: 'signal', device: 'mobile' }) }}
              style={{
                display: 'flex', alignItems: 'center', gap: '6px',
                padding: '10px 16px', background: 'var(--bg-secondary)',
                border: '1px solid var(--border-color)', borderRadius: '24px',
            ...
            <button
              onClick={() => { setMobileDrawer('chat'); trackEvent('chat_opened', { page: 'signal', device: 'mobile' }) }}
              style={{
                display: 'flex', alignItems: 'center', gap: '6px',
                padding: '10px 16px', background: 'rgba(99,102,241,0.15)',
                border: '1px solid #6366f1', borderRadius: '24px',
...
color: 'var(--text-muted)', cursor: 'pointer', fontSize: '12px',
        ...
        {chatOpen && !(areasOpen && selectedArea) ? (
          ...
          <button
           onClick={() => { setChatOpen(true); trackEvent('chat_opened', { page: 'signal', device: 'desktop' }) }}
            style={{
              flexShrink: 0, width: 36, background: 'var(--bg-primary)',
borderLeft: '1px solid var(--border-color)', border: 'none',
              color: '#6366f1', cursor: 'pointer',
