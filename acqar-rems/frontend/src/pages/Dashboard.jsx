...
//     return params.get('theme') || localStorage.getItem('acqar-theme') || 'dark'
//   })
...
//             <div style={{
//               display: 'flex', alignItems: 'center', justifyContent: 'space-between',
//               padding: '12px 16px 8px', borderBottom: '1px solid var(--border-col)', flexShrink: 0,
//             }}>
//               <span style={{ fontSize: '11px', fontWeight: 800, color: '#B87333', letterSpacing: '1px' }}>◆ FEED</span>
//               <button
//                 onPointerDown={(e) => { e.stopPropagation(); e.preventDefault(); setMobileDrawer(null); }}
...
//                 onClick={(e) => { e.stopPropagation(); e.preventDefault(); setMobileDrawer(null); }}
//                 style={{
//                   width: 44, height: 44, background: 'var(--bg-panel)',
// border: '1px solid var(--border-col)', borderRadius: '6px',
// color: 'var(--text-1)', cursor: 'pointer', fontSize: '18px',
//                   display: 'flex', alignItems: 'center', justifyContent: 'center',
//                   touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent',
//                   userSelect: 'none', WebkitUserSelect: 'none',
//                 }}
...
// border: '1px solid var(--border-col)', borderRadius: '24px',
...
//   // ── DESKTOP ───────────────────────────────────────────────────────────────
//   return (
//     <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100vh', overflow: 'hidden', background: 'var(--bg-page)' }}>
//       <Header theme={theme} onToggleTheme={toggleTheme} />
//       <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>

//         <div style={{
//           flexShrink: 0, width: leftCollapsed ? 0 : 320,
//           overflow: 'hidden', borderRight: '1px solid var(--border-col)',
//           transition: 'width 0.3s', position: 'relative',
//         }}>
//           <div style={{ width: 320, height: '100%', display: 'flex', flexDirection: 'column' }}>
//             <FilterBar />
...
//           style={{
//             flexShrink: 0, width: 20,
//             background: 'var(--bg-panel)', border: 'none', borderRight: '1px solid var(--border-col)',
...
//         {chatOpen ? (
//           <div style={{ flexShrink: 0, width: 340, borderLeft: '1px solid var(--border-col)',display: 'flex', flexDirection: 'column' }}>
...
//             onClick={() => setChatOpen(true)}
//             style={{
//               flexShrink: 0, width: 36, background: 'var(--bg-panel)',
// borderLeft: '1px solid var(--border-col)', border: 'none',
//               color: '#6366f1', cursor: 'pointer',
//               display: 'flex', flexDirection: 'column',
//               alignItems: 'center', justifyContent: 'center', gap: '6px',
//             }}
